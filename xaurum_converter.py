...
# Let op: geen hardcoded gebruikersnaam, we vertrekken van de homefolder.
# Voor alle gebruikers met dezelfde EQUANS-syncstructuur werkt dit:
#   C:\Users\<WINDOWS_LOGIN>\EQUANS\Operations Support - Trainingapp
BASE = Path.home() / "EQUANS" / "Operations Support - Trainingapp"

# XaurumTools-map binnen de bibliotheek
ROOT = BASE / "XaurumTools"
INBOX = ROOT / "downloads"                   # bronmap met .xls/.xlsx
LOGS  = ROOT / "logs"
CONVERTER_XLSM = ROOT / "Master" / "Converter_Xaurum.xlsm"

# Outputmappen staan direct onder de SharePoint-bibliotheek
OUT_STAFF_DIR    = BASE / "ReadyForFlow-Personeel"
OUT_CERT_DIR     = BASE / "ReadyForFlow-Certificates"
OUT_COMP_DIR     = BASE / "ReadyForFlow-Competences"
OUT_TRAIN_DIR    = BASE / "ReadyForFlow-Training"
OUT_CERTRES_DIR  = BASE / "ReadyForFlow-CertResults"
